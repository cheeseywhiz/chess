...
class Games
{
  public:
     ...
     */
    explicit Games(const Row &r, const ssize_t indexOffset = 0) noexcept;
    ...
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getWhite() const noexcept;

    ///Set the value of the column white
    void setWhite(const std::string &pWhite) noexcept;
    void setWhite(std::string &&pWhite) noexcept;


    /**  For column black  */
    ///Get the value of the column black, returns the default value if the column is null
    const std::string &getValueOfBlack() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getBlack() const noexcept;

    ///Set the value of the column black
    void setBlack(const std::string &pBlack) noexcept;
